...
Theorem andb_eq_orb :
  ...
  (andb b c = orb b c) ->
  b = c.
Proof. destruct b; destruct c; try reflexivity; discriminate.
Qed.

Theorem add_assoc : forall n m p : nat,
n + (m + p) = (n + m) + p.
Proof. intros; induction n; simpl; try rewrite IHn; reflexivity. 
Qed.
...
Proof. intros; induction lst1; try (destruct x; simpl; rewrite IHlst1); reflexivity.
Qed.
...
Proof.
  ...
  induction M
    as [| x'
        ...
        | s1 re1 re2 Hmatch IH | re1 s2 re2 Hmatch IH
       | re | s1 s2 re Hmatch1 IH1 Hmatch2 IH2];
  simpl; try constructor. destruct re1. 
  - (* MApp *) 
    destruct re1.
    + inversion IH1.
    + inversion IH1. simpl. destruct re2.
...
Theorem andb_true_elim2' : forall b c : bool,
    andb b c = true -> c = true.
Proof. intros; destructpf' c; destructpf' b. Qed.
