...
Proof.
  intros n m H1 H2. induction H1 as [Heq | n' IHn'  Heq].
  - simpl. apply H2.
  - simpl. apply ev_SS. apply Heq.
Qed.
...
Proof.
  ...
  - intros H. induction H.
    + apply ev'_0.
    + assert (Hc : S (S n) = 2 + n). { reflexivity. }
      rewrite Hc. apply ev'_sum. apply ev'_2. apply IHev.
Qed.
...
Proof.
  intros n m H1 H2. induction H2 as [| n' IHn'].
  - simpl in H1. apply H1.
  - simpl in H1. inversion H1. apply IHIHn' in H0. apply H0.
Qed.
...
Proof.
  intros m n o H1 H2. transitivity n. apply H1. apply H2.
Qed.
...
Proof.
  ...
  - destruct n. apply le_n. inversion H.
  - inversion H. apply le_n. apply IHm' in H1. apply le_S. apply H1.
Qed.
...
Proof.
  ...
  - apply le_n.
  - rewrite le_S. apply H1. apply le_n.
Qed.

Theorem lt_ge_cases : forall n m,
  n < m \/ n >= m.
Proof.
  intros n m. induction n as [|n' [IH|IH]].
  - destruct m as [|m'].
    + right. apply le_n.
    + left. apply n_le_m__Sn_le_Sm. apply O_le_n.
  - destruct m.
    + right. apply O_le_n.
    + unfold lt in *. inversion IH.
      * right. apply le_n.
      * left. apply n_le_m__Sn_le_Sm. apply H0.
  - unfold lt in *. right.
    apply le_trans with (n := n').
    apply IH. apply (le_S n' n' (le_n n')).
Qed.
...
Proof.
  intros n m H. assert (Hc : S n = n + 1). { rewrite add_comm. reflexivity. }
  rewrite Hc in H. rewrite <- le_plus_l in H. apply H.
Qed.
...
Proof.
  ...
  - intros m p q H. destruct p as [|p'].
    + right. apply plus_le in H. simpl in H. destruct H as [H1 H2]. apply H2.
    + simpl in H. apply Sn_le_Sm__n_le_m in H. apply IHn' in H.
      destruct H as [H | H]. left. apply n_le_m__Sn_le_Sm. apply H.
      right. apply H.
Qed.
...
Proof.
  ...
  - rewrite <- plus_n_Sm. apply (le_S n (m + p')  IHp').
Qed.
...
Theorem n_lt_m__n_le_m : forall n m,
  ...
  n <= m.
Proof.
  intros n m H. unfold lt in H. apply Sn_le_m in H. apply H.
Qed.
...
Theorem plus_lt : forall n1 n2 m,
  ...
  n1 < m /\ n2 < m.
Proof.
  intros n1 n2 m H. destruct m as [|m'].
  - inversion H.
  - apply Sn_le_Sm__n_le_m in H. split.
    + apply n_le_m__Sn_le_Sm. rewrite le_plus_l with (b := n2). 
      apply H.
    + apply n_le_m__Sn_le_Sm. rewrite add_comm in H.
      rewrite le_plus_l with (b := n1). apply H.
Qed.
...
Proof.
  ...
  - intros n H. destruct n as [|n'].
    + reflexivity.
    + apply Sn_le_Sm__n_le_m in H. apply IHm' in H. simpl.
      apply H.
Qed.
...
Proof.
  ...
  apply leb_correct. transitivity m. apply H1. apply H2.
Qed.
...
(** - Which of the following propositions are provable?
    ...
    - If we dropped constructor [c5] from the definition of [R],
      ...
      answer: no, c5 is convenient but not necessary.

    - If we dropped constructor [c4] from the definition of [R],
      would the set of provable propositions change?  Briefly (1
      sentence) explain your answer.

      answer: no, c4 is just a combination of c2 and c3.
*)
...
Proof.
  ...
  - intros H. unfold fR. induction H.
    ...
    + simpl. rewrite <- plus_n_Sm. apply eq_S. apply IHR.
    + rewrite <- plus_n_Sm in IHR. simpl in IHR.
      injection IHR as eq. apply eq.
    + rewrite add_comm. apply IHR.
  - unfold fR. intros. subst.  induction m.
...
Inductive subseq : list nat -> list nat -> Prop :=
  | subseq_empty (l2 : list nat) : subseq [] l2
  | subseq_eq (n : nat) (l1 l2 : list nat) (H : subseq l1 l2) : subseq (n :: l1) (n :: l2)
  | subseq_diff (n : nat) (l1 l2 : list nat) (H : subseq l1 l2) : subseq l1 (n :: l2)
.
...
Proof.
  ...
  - apply subseq_empty.
  - simpl. apply subseq_eq. apply IHsubseq.
  - simpl. apply subseq_diff. apply IHsubseq.    
Qed.
...
Proof.
  ...
  induction H2 as [|n l2' l3' IHl2' IHl3'|n l2' l3' IHl2' IHl3'].
  - intros l1 H. inversion H. apply subseq_empty.
  - intros l1 H. inversion H as [|x l1'' l2'' H12'| x l1'' l2'' H12'].
    + apply subseq_empty.
    + apply subseq_eq. apply (IHl3' l1'' H12').
    + apply subseq_diff. apply (IHl3' l1 H12').
  - intros l1 H. apply subseq_diff. apply (IHl3' l1 H).
Qed.
...
Proof.
  ...
  - discriminate Heqre'.
  - discriminate Heqre'.
  - exists []. simpl. split. reflexivity. intros s' [].
  - inversion Heqre' as [H']. rewrite H' in *. apply IHexp_match2 in Heqre'.
    destruct Heqre' as [ss [H1 H2]]. exists (s1 :: ss). simpl. rewrite <- H1. split.
    + reflexivity.
    + intros s' H3. destruct H3.
      * rewrite <- H3. apply H.
...
Proof.
  intros n l. induction l as [| m l' IHl'].
  - intros H contra. destruct contra.
  - simpl. destruct (eqbP n m) as [H|H].
   + intros H'. discriminate.
   + intros H'. apply IHl' in H'. intros [contra|contra].
...
Inductive nostutter {X:Type} : list X -> Prop :=
  | nostut_empty : nostutter []
  | nostut_single n : nostutter [n]
  | nostut_diff n m l (P : n <> m) (H : nostutter (m :: l)) : nostutter (n :: m :: l)
.
...
Inductive merge {X:Type} : list X -> list X -> list X -> Prop :=
  | merge_empty :  merge [] [] []
  | merge_r n l1 l2 l (H : merge l1 l2 l) : merge l1 (n :: l2) (n :: l)
  | merge_l n l1 l2 l (H : merge l1 l2 l) : merge (n :: l1) l2 (n :: l)
.
...
Proof.
  ...
  - simpl. destruct (test n) eqn:E.
    + destruct H3 as [contra _]. rewrite E in contra.
      discriminate contra.
    + destruct H3 as [_ H3]. apply (IHmerge H2 H3).
  - simpl. destruct (test n) eqn:E.
    + destruct H2 as [_ H2]. assert (H : filter test l = l1).
      { apply (IHmerge H2 H3). } rewrite H. reflexivity.
    + destruct H2 as [contra _]. rewrite E in contra. discriminate contra.
Qed.
...
Inductive pal {X:Type} : list X -> Prop :=
  | pal_empty : pal []
  | pal_single n : pal [n]                
  | pal_list l1 l2 (P : l1 = rev l2) : pal (l1 ++ l2)
.

Theorem pal_app_rev : forall (X:Type) (l : list X),
  pal (l ++ (rev l)).
Proof.
  intros X l. apply pal_list. rewrite rev_involutive. reflexivity.
Qed.

Theorem pal_rev : forall (X:Type) (l: list X) , pal l -> l = rev l.
Proof.
  intros X l H. destruct H.
  - reflexivity.
  - reflexivity.
  - rewrite P. rewrite rev_app_distr. rewrite rev_involutive. reflexivity.
Qed.
...
Inductive disjoint_lists {X: Type} : list X -> list X -> Prop :=
  | disjoint_empty l2: disjoint_lists [] l2
  | disjoint_step n l1 l2 (H : ~ In n l2 /\ disjoint_lists l1 l2) : disjoint_lists (n :: l1) l2
.
...
Inductive NoDup {X : Type} : list X -> Prop :=
  | nodup_empty : NoDup []
  | nodup_step n l (H : ~ In n l /\ NoDup l) : NoDup (n :: l)
.

(** Finally, state and prove one or more interesting theorems relating
    [disjoint], [NoDup] and [++] (list append).  *)

Theorem nodup_disjoint_app:
  forall (X: Type) (l1 l2: list X),
  NoDup l1 -> NoDup l2 -> disjoint_lists l1 l2 ->
  NoDup (l1 ++ l2).
Proof.
  intros X l1 l2 H1 H2 H3. induction l1 as [|n l1' IH].
  - apply H2.
  - simpl. apply nodup_step. inversion H3. inversion H1. 
    subst. destruct H5 as [H4 H5]. destruct H7 as [H6 H7]. split.
    + intros contra. apply In_app_iff in contra. destruct contra.
      * contradiction.
      * contradiction.
    + apply IH. apply H7. apply H5.
Qed.
...
Proof.
  intros X x l H. induction l as [|n l' IH].
  - simpl in H. destruct H.
  - simpl in H. destruct H as [H|H].
    + exists [], l'. simpl. rewrite H. reflexivity.
    + apply IH in H. destruct H as [l1 [l2 H]]. exists (n :: l1), l2.
...
Inductive repeats {X:Type} : list X -> Prop :=
  | rep n l (H : In n l \/ repeats l) : repeats (n :: l)
.
...
Proof.
  ...
  - intros. apply rep. destruct (EM (In x l1')).
    + left. apply H1.
    + right. destruct (in_split _ x l2) as [l0 [l2' H2]].
      * apply H. simpl. left. reflexivity.
      * apply IHl1' with (l2 := l0 ++ l2').
...
Proof.
  intros. split.
  - intros. apply app_exists in H. destruct H as [s1 [s2 [H1 [H2 H3]]]].
    destruct s1.
    + simpl in H1. rewrite <- H1 in H3. left. split.
      * apply H2.
      * apply H3.
    + simpl in H1. inversion H1. subst x. right. exists s1, s2.
      split. reflexivity. split. apply H2. apply H3.
  - intros [[H1 H2]|H3].
    + apply app_exists. exists [], (a :: s).
      split. reflexivity. split. apply H1. apply H2.
    + destruct H3 as [s1 [s2 [H1 [H2 H3]]]]. apply app_exists.
      exists (a :: s1), s2. simpl. split. rewrite H1. reflexivity.
